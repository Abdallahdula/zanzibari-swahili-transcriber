...
export default function AudioTools({ onTranscribe, isProcessing }: AudioToolsProps) {
  ...
  const loadingMessages = [
    "Inapakia sauti yako salama katika tovuti ya Zanzibar...",
    "Gemini 3.5 inapitia lafudhi ya Kiunguja ya wazungumzaji...",
    "Kubainisha misemo ya asili ya Stone town ('Mambo yange', 'Viwalo')...",
    "Kuhakiki maneno yenye asili ya Kiarabu na kuisanifu kwa ufasaha...",
    "Kugawanya dondoo za mazungumzo na kuweka muda (Timestamping)...",
    "Kukamilisha muhtasari wa maazimio na miongozo ya kazi (Action Items)..."
  ];
  ...
  const startRecording = async () => {
    ...
    try {
      ...
      alert("Haikuweza kupata kipaza sauti chako (Microphone). Tafadhali kubali ruhusa ya Microphone au pakia faili lililorekodiwa.");
    }
  };
  ...
  return (
    <div id="audio-tools" className="font-sans">
      {isProcessing ? (
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-10 flex flex-col items-center justify-center text-center space-y-6 min-h-[400px]">
          ...
          <div className="space-y-2 max-w-md">
            ...
            <p className="text-xs text-slate-500 pt-4 border-t border-slate-850">
              Sekunde chache... Gemini inapitia upya lafudhi ya dondoo hili ili kuhakikisha usahihi mzuri wa misemo yote.
            </p>
          </div>
        </div>
      ) : (
          ...
          <div className="lg:col-span-7 bg-slate-900 border border-slate-800 rounded-2xl p-6 flex flex-col justify-between">
            <div>
              <h3 className="text-base font-bold text-slate-200 flex items-center gap-2 mb-4">
                ...
                Sajili Chanzo cha Sauti (Add Audio Raw)
              </h3>
              ...
              {isRecording ? (
                ...
                <div className="space-y-4 font-sans">
                      ...
                      <div className="space-y-3 z-20">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-xs text-slate-500">
                            {(selectedFile.size / (1024 * 1024)).toFixed(2)} MB • {selectedFile.type || "Sauti"}
                          </p>
                        </div>
                        <button
                          onClick={(e) => {
                  ...
                  >
                    ...
                    <span>Rekodi Mazungumzo Moja kwa Moja (Live Record)</span>
                  </button>
          ...
          <div className="lg:col-span-5 bg-slate-900 border border-slate-800 rounded-2xl p-6 flex flex-col justify-between">
            <div className="space-y-4">
              <h3 className="text-base font-bold text-slate-200 flex items-center gap-2">
                ...
                Habari ya Kikao (Context & Settings)
              </h3>

              {/* Title input */}
              <div className="space-y-1.5 font-sans">
                <label className="text-xs font-semibold text-slate-400 uppercase tracking-wider block">Kichwa cha Kikao (Meeting Title - Optional)</label>
                <input
                  id="input-meeting-title"
                  type="text"
                  placeholder="Kikao cha maporomoko ya Stone Town..."
                  value={meetingTitle}
              ...
              <div className="space-y-1.5 font-sans">
                <label className="text-xs font-semibold text-slate-400 uppercase tracking-wider block">Muktadha / Wazungumzaji (Context & Speakers - Optional)</label>
                <textarea
                  id="textarea-meeting-context"
                  placeholder="Andika majina ya wazungumzaji (mf. Ali, Fatma) au mada (mf. soko la viungo, utalii) ili kuongeza ufanisi mzuri wa tafsiri."
            ...
            <div className="pt-6 border-t border-slate-800/80">
              ...
              >
                ...
                <span>Geuza Sauti Kuwa Maandishi (Analyze Swahili)</span>
              </button>
              
              {!selectedFile && (
                <p className="text-center text-[10px] text-slate-500 mt-2 font-mono">
                  Pakia faili au rekodi sauti kwanza ili kuanza.
                </p>
              )}
            </div>
