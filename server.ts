        ...
        transcript: {
          ...
          items: {
            ...
            properties: {
              ...
              text: { type: Type.STRING, description: "Exact verbatim coastal Zanzibari Swahili transcription. Capture original words, dialect, slang, and only clearly audible important non-speech events. Only if a cough is clearly audible, write exactly: A patient coughs." },
...
5. PATIENT COUGH EVENTS: Only add a cough event when a cough is clearly audible in the audio. Do not infer or guess a cough from pauses, unclear sounds, breathing, background noise, or ordinary speech. If a cough is clearly audible, add it as its own transcript turn at the correct timestamp and set the text to exactly "A patient coughs." Do not write only "[cough]" or "(cough)".
